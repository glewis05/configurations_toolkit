...
Examples:
  ...
  Update provider NPI:
    ...
    # =========================================================================
    # Commands for Part 11, HIPAA, and SOC 2 compliance tracking
    ...
    parser.add_argument('--role', type=str,
                        choices=['Admin', 'Provider', 'Coordinator', 'Read-Only', 'Auditor'],
                        help="Access role")
    ...
    parser.add_argument('--training-type', type=str,
                        choices=['HIPAA Privacy', 'HIPAA Security', 'Part 11', 'SOC 2', 'PHI Handling'],
